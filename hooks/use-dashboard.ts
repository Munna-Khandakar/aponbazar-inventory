...
export const useKPIComparison = createStaticHook(dashboardService.getKPIComparison)
...
export const useProductPerformance = createStaticHook(dashboardService.getProductPerformance)
